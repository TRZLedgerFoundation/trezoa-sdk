...
mod serde_snapshot_tests {
        ...
        R: Read,
    {
        ...
        reconstruct_accountsdb_from_fields(
            ...
            false,
            Some(trezoa_accounts_db::accounts_db::ACCOUNTS_DB_CONFIG_FOR_TESTING),
            None,
            Arc::default(),
            None,
            (u64::default(), None),
        ...
        F: Fn(AccountsDb, Slot) -> AccountsDb,
    {
        ...
        let pubkey = trezoa_sdk::pubkey::new_rand();
        let purged_pubkey1 = trezoa_sdk::pubkey::new_rand();
        let purged_pubkey2 = trezoa_sdk::pubkey::new_rand();
    ...
    fn test_accounts_purge_long_chained_after_snapshot_restore() {
        ...
        let pubkey = trezoa_sdk::pubkey::new_rand();
        let dummy_pubkey = trezoa_sdk::pubkey::new_rand();
        let purged_pubkey1 = trezoa_sdk::pubkey::new_rand();
        let purged_pubkey2 = trezoa_sdk::pubkey::new_rand();
