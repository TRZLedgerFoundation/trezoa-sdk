...
fn main() {
    // Tell Rust to recognize our custom cfg flags
    ...
    println!("cargo:rustc-check-cfg=cfg(RUSTC_NEEDS_PROC_MACRO_HYGIENE)");
    println!("cargo:rustc-check-cfg=cfg(target_os, values(\"trezoa\"))");
    ...
    match version_meta().unwrap().channel {
        ...
        Channel::Dev => {
            println!("cargo:rustc-cfg=RUSTC_WITH_SPECIALIZATION");
            // See https://github.com/Trezoa-team/Trezoa/issues/11055
