 ...
 */
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/sbf/c/inc/trz/inc/return_data.inc AND RUN `cargo run --bin gen-headers` */
#ifndef TRZ_SBFV2
...
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/sbf/c/inc/trz/inc/return_data.inc AND RUN `cargo run --bin gen-headers` */
#ifndef TRZ_SBFV2
uint64_t trz_get_return_data(uint8_t *, uint64_t, TrzPubkey *);
#else
typedef uint64_t(*trz_get_return_data_pointer_type)(uint8_t *, uint64_t, TrzPubkey *);
static uint64_t trz_get_return_data(uint8_t * arg1, uint64_t arg2, TrzPubkey * arg3) {
