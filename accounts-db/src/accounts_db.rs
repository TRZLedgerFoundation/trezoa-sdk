...
use {
    ...
    trezoa_nohash_hasher::{IntMap, IntSet},
...
pub fn make_min_priority_thread_pool() -> ThreadPool {
    ...
    rayon::ThreadPoolBuilder::new()
        .thread_name(|i| format!("trzAccountsLo{i:02}"))
...
impl AccountsDb {
    ...
    fn default_with_accounts_index(
        ...
        AccountsDb {
            ...
            thread_pool: rayon::ThreadPoolBuilder::new()
                .num_threads(num_threads)
                .thread_name(|i| format!("trzAccounts{i:02}"))
    ...
    fn start_background_hasher(&mut self) {
        ...
        Builder::new()
            .name("trzDbStoreHashr".to_string())
            .spawn(move || {
        ...
        F: FnMut(Option<(&Pubkey, AccountSharedData, Slot)>),
    {
        let key = match &index_key {
            ...
            IndexKey::TplTokenMint(key) => key,
            IndexKey::TplTokenOwner(key) => key,
        };
...
pub mod tests {
    ...
    fn test_get_keys_to_unref_ancient() {
        ...
        let pubkey4 = trezoa_sdk::pubkey::new_rand();
    ...
    fn test_clean_old_with_both_normal_and_zero_lamport_accounts() {
        ...
        let mut account_data_with_mint = vec![0; inline_tpl_token::Account::get_packed_len()];
        ...
        normal_account.set_owner(inline_tpl_token::id());
        ...
        zero_account.set_owner(inline_tpl_token::id());
        ...
        let index_key = IndexKey::TplTokenMint(mint_key);
        let bank_id = 0;
        accounts
            .accounts_index
            .index_scan_accounts(
        ...
        accounts
            ...
            .index_scan_accounts(
                &Ancestors::default(),
                bank_id,
                IndexKey::TplTokenMint(mint_key),
    ...
    fn test_verify_bank_capitalization() {
        for pass in 0..2 {
            ...
            let native_account_pubkey = trezoa_sdk::pubkey::new_rand();
            db.store_for_tests(
                some_slot,
                &[(
                    &native_account_pubkey,
                    &trezoa_sdk::native_loader::create_loadable_account_for_test("foo"),
                )],
            );
            db.add_root_and_flush_write_cache(some_slot);
            db.update_accounts_hash_for_tests(some_slot, &ancestors, true, true);
    ...
    fn test_storage_finder() {
        ...
        let lamports = 100;
        let data_len = 8190;
        let account = AccountSharedData::new(lamports, data_len, &trezoa_sdk::pubkey::new_rand());
    ...
    fn test_account_balance_for_capitalization_sysvar() {
        let normal_sysvar = trezoa_sdk::account::create_account_for_test(
            &trezoa_sdk::slot_history::SlotHistory::default(),
        );
    ...
    fn test_flush_accounts_cache() {
        ...
        let root5 = 5;
        let root6 = 6;
        let unrooted_key = trezoa_sdk::pubkey::new_rand();
        let key5 = trezoa_sdk::pubkey::new_rand();
        let key6 = trezoa_sdk::pubkey::new_rand();
    ...
    fn test_calculate_storage_count_and_alive_bytes() {
        ...
        let shared_key = trezoa_sdk::pubkey::new_rand();
        let account = AccountSharedData::new(1, 1, AccountSharedData::default().owner());
        let slot0 = 0;
    ...
    fn test_calculate_storage_count_and_alive_bytes_2_accounts() {
        let accounts = AccountsDb::new_single_for_tests();
        let keys = [
            trezoa_sdk::pubkey::Pubkey::from([0; 32]),
            trezoa_sdk::pubkey::Pubkey::from([255; 32]),
        ];
        accounts.accounts_index.set_startup(Startup::Startup);
    ...
    fn test_clean_accounts_with_last_full_snapshot_slot() {
        ...
        let accounts_db = AccountsDb::new_single_for_tests();
        let pubkey = trezoa_sdk::pubkey::new_rand();
        let owner = trezoa_sdk::pubkey::new_rand();
        let space = 0;
