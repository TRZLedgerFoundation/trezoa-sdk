 ...
 */
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/bpf/c/inc/trz/inc/log.inc AND RUN `cargo run --bin gen-headers` */
#ifndef TRZ_SBFV2
...
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/bpf/c/inc/trz/inc/log.inc AND RUN `cargo run --bin gen-headers` */
#ifndef TRZ_SBFV2
void trz_log_data(TrzBytes *, uint64_t);
#else
typedef void(*trz_log_data_pointer_type)(TrzBytes *, uint64_t);
static void trz_log_data(TrzBytes * arg1, uint64_t arg2) {
 ...
 */
static void trz_log_params(const TrzParameters *params) {
