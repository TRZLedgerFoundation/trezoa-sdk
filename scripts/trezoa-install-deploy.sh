...
case $TAG in
edge|beta)
  DOWNLOAD_URL=https://release.trezoa.com/"$TAG"/trezoa-release-$TARGET.tar.bz2
  ;;
*)
  DOWNLOAD_URL=https://github.com/trezoa-team/trezoa/releases/download/"$TAG"/trezoa-release-$TARGET.tar.bz2
  ;;
esac
