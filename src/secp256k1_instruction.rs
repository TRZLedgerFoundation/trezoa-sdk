...
//!
//! [np]: https://docs.trezoa-team.com/runtime/programs#secp256k1-program
//!
...
//! [`secp256k1_program`]: trezoa_program::secp256k1_program
//! [`secp256k1_recover`]: trezoa_program::secp256k1_recover
...
//!
//! The `trezoa_sdk` crate provides few APIs for building the instructions and
...
//!
//! The Trezoa program. Note that it uses `libsecp256k1` version 0.7.0 to parse
...
//!
//! ```no_run
//! # use trezoa_sdk::example_mocks::trezoa_rpc_client;
//! use anyhow::Result;
...
//!         trezoa_sdk::secp256k1_program::ID,
...
pub fn new_secp256k1_instruction(
    ...
    Instruction {
        program_id: trezoa_sdk::secp256k1_program::id(),
        accounts: vec![],
...
///
/// `feature_set` is the set of active Trezoa features. It is used to enable or
