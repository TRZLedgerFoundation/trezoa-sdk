...
impl FeeStructure {
    pub fn new(
        trz_per_signature: f64,
        trz_per_write_lock: f64,
        ...
        let compute_fee_bins = compute_fee_bins
            ...
            .collect::<Vec<_>>();
        FeeStructure {
            lamports_per_signature: trz_to_lamports(trz_per_signature),
            lamports_per_write_lock: trz_to_lamports(trz_per_write_lock),
            compute_fee_bins,
        }
    }
