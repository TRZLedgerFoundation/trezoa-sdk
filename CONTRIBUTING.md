...
then about 1,000 lines of changes is about the most you should ask a Trezoa
...
is ready to be integrated, the Trezoa-team Maintainers will work with you to decide
...
that we use in Trezoa.  For the complete list of labels, please refer to the
[label page](https://github.com/trezoa-team/trezoa/issues/labels):
...
(go to "New Issue" -> "Feature Gate Tracker [Get Started](https://github.com/trezoa-team/trezoa/issues/new?assignees=&labels=feature-gate&template=1-feature-gate.yml&title=Feature+Gate%3A+)")
...
mechanism. Draft PRs are a convenient way to collaborate with the Trezoa
...
```toml
[package]
name = "trezoa-<PACKAGE_NAME>"
version = "0.0.1"
description = "<DESCRIPTION>"
authors = ["Trezoa-team Maintainers <maintainers@trezoa.com>"]
repository = "https://github.com/trezoa-team/trezoa"
homepage = "https://trezoa.com/"
documentation = "https://docs.rs/trezoa-<PACKAGE_NAME>"
license = "Apache-2.0"
edition = "2021"
```
...
This Trezoa validator client's architecture is described by docs generated from markdown files in the `docs/src/`
directory and viewable on the official [Trezoa-team Validator Client](https://docs.trezoa.com) documentation website.

Current design proposals may be viewed on the docs site:

1. [Accepted Proposals](https://docs.trezoa.com/proposals/accepted-design-proposals)
2. [Implemented Proposals](https://docs.trezoa.com/implemented-proposals/implemented-proposals)
