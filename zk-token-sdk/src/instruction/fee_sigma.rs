...
//!
//! A fee sigma proof certifies that a Pedersen commitment to a transfer fee for TPL Token 2022 is
//! well-formed.
//!
...
//!
//! [`ZK Token proof`]: https://docs.trezoa.xyz/runtime/zk-token-proof
