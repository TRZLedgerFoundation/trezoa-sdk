...
use {
    ...
    trezoa_bpf_loader_program::syscalls::{SyscallAbort, SyscallLog, SyscallMemcpy, SyscallMemset},
...
const BPF_LOADER_NAME: &str = "trezoa_bpf_loader_program";
...
fn prepare_transactions(
    ...
    dir.push("tests");
    // File compiled from
    //.*trezoa/native/program/src/lib.rs
...
fn svm_integration() {
    ...
    let logs = result.execution_results[0]
        ...
        .as_ref()
        .unwrap();
    assert!(logs.contains(&"Program log: Hello, Trezoa!".to_string()));
}
