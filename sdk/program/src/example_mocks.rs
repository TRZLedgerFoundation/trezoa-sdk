...
/// trezoa-program.
///
/// This lets examples in trzana-program appear to be written as client
/// programs.
pub mod trezoa_sdk {
    pub use crate::{
    ...
    #[deprecated(
        since = "1.17.0",
        note = "Please use `trezoa_sdk::address_lookup_table` instead"
    )]
...
pub mod trezoa_address_lookup_table_program {
