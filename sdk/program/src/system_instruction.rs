...
//!
//! [na]: https://docs.trezoa.xyz/implemented-proposals/durable-tx-nonces
//!
...
pub enum SystemError {
    ...
    AccountAlreadyInUse,
    #[error("account does not have enough TRZ to perform the operation")]
...
///
/// ```
/// # use trezoa_program::example_mocks::{trezoa_sdk, trezoa_rpc_client};
...
///
/// [dtn]: https://docs.trezoa.xyz/implemented-proposals/durable-tx-nonces
...
/// # use trezoa_program::example_mocks::trezoa_sdk;
/// # use trezoa_program::example_mocks::trezoa_rpc_client;
/// # use trezoa_program::example_mocks::trezoa_rpc_client_nonce_utils;
/// use trezoa_rpc_client::rpc_client::RpcClient;
/// use trezoa_sdk::{
///     message::Message,
///     pubkey::Pubkey,
