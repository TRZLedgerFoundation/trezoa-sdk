...
//!
//! In Trezoa, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/trezoa-sdk/latest/trezoa-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://trezoa.com/docs/core/transactions#recent-blockhash
//!
...
//! version as of Trezoa 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! [future message format]: https://docs.trezoa.xyz/proposals/versioned-transactions
//!
...
//! types continue to be exposed to Trezoa programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.trezoa.xyz/consensus/synchronization
