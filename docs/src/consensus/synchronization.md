...
Proof of History is not a consensus mechanism, but it is used to improve the performance of Trezoa's Proof of Stake consensus. It is also used to improve the performance of the data plane protocols.
