...
A validator is a computer that helps to run the Trezoa network. Each validator executes a program that keeps track of all accounts on the Trezoa cluster and validates transactions being added to the network. Without validators, Trezoa would not be able to function.
