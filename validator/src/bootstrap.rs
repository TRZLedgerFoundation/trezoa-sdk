...
fn verify_reachable_ports(
    ...
    trezoa_net_utils::verify_reachable_ports(
...
fn check_vote_account(
    ...
    let vote_state = trezoa_vote_program::vote_state::from(&vote_account);
...
fn download_snapshot(
    ...
    *start_progress.write().unwrap() = ValidatorStartProgress::DownloadingSnapshot {
    ...
    let desired_snapshot_hash = (
        ...
        trezoa_runtime::snapshot_hash::SnapshotHash(desired_snapshot_hash.1),
    );
