...
mod tests {
    use {
        ...
        serial_test::serial,
        trezoa_account_decoder::{parse_account_data::parse_account_data, UiAccountEncoding},
        ...
        trezoa_vote_program::vote_state::Vote,
        std::{
            sync::{
    ...
    fn test_account_subscribe() {
        ...
        let new_stake_authority = trezoa_sdk::pubkey::new_rand();
